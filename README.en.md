...
That frustration is why I made **Panel 056**. It does not press a template onto your image. It first works out what must not be lost, then translates it into **Keep one core image, then repaint it with vast whitespace, paused marks, and warm–cool colour shifts**.
...
<table>
  ...
  <tr>
    <td colspan="2"><img src="./assets/examples/sample-05.png" alt="XXD Panel 056 Sample 5"></td>
  </tr>
  <tr>
    <td width="33%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 056 Sample 6"></td>
    <td width="33%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 056 Sample 7"></td>
    <td width="33%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 056 Sample 8"></td>
  </tr>
</table>
...
The style finds the photograph's core image, visual metaphor, or meaningful distance between things, retaining one subject and very few narrative relations. It neither illustrates every object nor fills the background; emptiness carries air, time, and emotion.

```text
lock identity and key posture → identify the core image or metaphor → remove irrelevant setting and objects → keep one subject and very few relations → build distance with vast near-white space → repaint with opaque masses, paused strokes, exposed ground, and local colour shifts → integrate only meaningful minimal text
```

## What makes the finished style recognizable

- One clearly recognizable core subject, supported by only the objects or spatial relations that truly participate in the story.
- A very pale, near-white ground that adapts to the source temperature, plus vast negative space that carries emotion.
- Opaque gouache, acrylic, pastel, and dry-oil marks retain pauses, corrections, exposed ground, and a slightly awkward hand.
- Cream yellow, apricot, peach, coral, and old rose meet sky blue, mint, and grey-green with relaxed warm–cool tension and occasional local colour shifts.
- The subject may sit off-centre, suspended, low, or partially cropped; text enters the space as part of the painting rather than as mechanical poster information.

Aesthetic constraints and rejection rules live only in the [original source brief](references/original-prompt/zh-CN.md); the Skill and runtime adapter handle delivery variables only. [Skill workflow](SKILL.md) · [English runtime adapter](references/xxd-panel-056-prompt.en.md)
