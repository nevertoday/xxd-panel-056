...
### 핵심 이미지 하나만 남기고 거대한 여백·멈춘 붓결·온냉 색 점프로 다시 그리기
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 056 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 056 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 056 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 056 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 056 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 056 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 056 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 056 예시 8"></td>
  </tr>
</table>

## 추가 3:4 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 056의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 056 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 056 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 056 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 056 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2091730850723586307) · 2026년 8월 24일<br>
> GPT2 × 따뜻한 색 × 아티스트 팔레트 × 미학 프롬프트 × VOL.056

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 056의 미학적 결과만 보여 줍니다. 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 새 작업의 참고나 기본값이 되지 않습니다.
...
**Panel 056**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **핵심 이미지 하나만 남기고 거대한 여백·멈춘 붓결·온냉 색 점프로 다시 그리기**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 056으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 056이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 핵심 이미지 하나만 남기고 거대한 여백·멈춘 붓결·온냉 색 점프로 다시 그리기 |
| **한눈에 알아볼 특징** | 핵심 이미지 · 거대한 여백 · 온냉 색 점프 · 서툰 손그림 · 시각적 은유 |
...
사진이 실제로 성립하는 핵심 이미지와 시각적 은유, 대상 사이의 의미 있는 거리를 찾고 하나의 주체와 극소수의 서사 관계만 남깁니다. 모든 물체를 그림으로 바꾸거나 배경을 채우지 않고 빈 공간이 공기와 시간, 감정을 맡게 합니다.

```text
정체성과 핵심 자세 고정 → 핵심 이미지／은유 판단 → 무관한 환경과 물체 삭제 → 하나의 주체와 극소수 관계 유지 → 흰색에 가까운 거대한 여백으로 거리 형성 → 불투명 색면, 멈춘 붓결, 바탕 노출, 국소 색 어긋남으로 재구성 → 의미 있는 최소 글자 통합
```

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- 분명히 알아볼 수 있는 핵심 주체 하나와 이야기에 실제로 참여하는 물체나 공간 관계만 남깁니다.
- 원본 색온도에 맞춰지는 흰색에 가까운 배경과 감정을 담는 거대한 음의 공간.
- 불투명 과슈, 아크릴, 파스텔, 마른 유화 흔적이 멈춤, 수정, 바탕 노출, 약간 서툰 손맛을 남깁니다.
- 크림 노랑, 살구, 복숭아, 코랄, 올드 로즈와 하늘색, 민트, 회녹색이 느슨한 온냉 긴장을 만들며 국소적인 색 어긋남도 허용합니다.
- 주체는 비대칭, 부유, 낮은 무게중심, 부분 재단으로 놓일 수 있고 글자는 기계적 정보가 아니라 그림의 일부로 여백에 들어갑니다.

미적 제약과 금지 항목은 [원본 프롬프트](references/original-prompt/zh-CN.md)에만 있으며 Skill과 런타임 어댑터는 이번 출력 변수만 처리합니다. [Skill](SKILL.md) · [영문 런타임 어댑터](references/xxd-panel-056-prompt.en.md)
...
Claude Code 사용자는 같은 폴더를 다음 위치에 연결할 수 있습니다: `~/.claude/skills/xxd-panel-056`. 설치 후 에이전트 세션을 다시 시작하세요.
...
전체 사양: [Skill 워크플로](SKILL.md) · [원본 스타일 자료](references/original-prompt/zh-CN.md) · [영문 런타임 어댑터](references/xxd-panel-056-prompt.en.md) · [중문 런타임 어댑터](references/xxd-panel-056-prompt.zh-CN.md)
