...
# 🦁 XXD Panel 056｜لوحة الذاكرة بالفراغ

### الإبقاء على صورة جوهرية واحدة وإعادة رسمها بفراغ واسع ولمسات متوقفة وقفزات لونية دافئة وباردة
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 056 نموذج 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 056 نموذج 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 056 نموذج 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 056 نموذج 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 056 نموذج 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 056 نموذج 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 056 نموذج 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 056 نموذج 8"></td>
  </tr>
</table>

## نماذج إضافية 3:4 بتكوين أعلى–أسفل

تعيد هذه الأعمال الأربعة استخدام المصادر المستقلة نفسها في مجموعة 16:9 أعلاه، لكن داخل لوحات كاملة 3:4 بتكوين أعلى–أسفل. تبقى الصورة الواقعية في الأعلى، ويُعاد بناء التصميم السفلي وفق الموجّه الأصلي لـ Panel 056. لا يُولَّد النص الإنجليزي إلا من محتوى كل صورة أو مزاجها أو دلالتها، وقد روجعت النتائج واحدةً واحدة.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 056 نموذج إضافي أعلى–أسفل 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 056 نموذج إضافي أعلى–أسفل 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 056 نموذج إضافي أعلى–أسفل 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 056 نموذج إضافي أعلى–أسفل 4"></td>
  </tr>
</table>

> [Xiaoxiaodong (@xiaoxiaodong01)](https://x.com/xiaoxiaodong01/status/2091730850723586307) · 24 أغسطس 2026<br>
> GPT2 × ألوان دافئة × لوحة فنان × موجّه جمالي × VOL.056

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091730850723586307">عرض المنشور الأصلي والتوجيه كاملاً ←</a></p>

تعرض هذه النماذج النتيجة الجمالية للإصدار 056 فقط؛ ولا تصبح موضوعاتها أو تكوينها أو ألوانها أو نصوصها أو نسبة اللوحة السابقة مراجع أو إعدادات افتراضية لمهمة جديدة.
...
يناسب **Panel 056** الأعمال التي تحتاج إلى الاحتفاظ بجوهر الصورة الأصلية مع السعي إلى هذا الاتجاه البصري: **الإبقاء على صورة جوهرية واحدة وإعادة رسمها بفراغ واسع ولمسات متوقفة وقفزات لونية دافئة وباردة**. يبدأ من الاستخدام المقصود والنتيجة المطلوبة، ثم يحدد التكوين والمقاس والنص وصيغة التسليم.
...
> استخدم XXD Panel 056 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 056 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | الإبقاء على صورة جوهرية واحدة وإعادة رسمها بفراغ واسع ولمسات متوقفة وقفزات لونية دافئة وباردة |
| **السمات التي تُعرف من النظرة الأولى** | صورة جوهرية · فراغ واسع · قفزات دافئة وباردة · يد فطرية · استعارة بصرية |
...
يبحث الأسلوب عن الصورة الجوهرية أو الاستعارة البصرية أو المسافة ذات المعنى بين الأشياء، ولا يحتفظ إلا بموضوع واحد وبعلاقات سردية قليلة جداً. لا يحول كل شيء إلى رسم ولا يملأ الخلفية؛ بل يجعل الفراغ يحمل الهواء والزمن والعاطفة.

```text
تثبيت الهوية والوضع الأساسي ← تحديد الصورة الجوهرية أو الاستعارة ← حذف البيئة والأشياء غير المهمة ← إبقاء موضوع واحد وعلاقات قليلة ← بناء المسافة بفراغ واسع قريب من الأبيض ← إعادة الرسم بكتل معتمة ولمسات متوقفة وأرضية ظاهرة وانزياحات لونية محلية ← دمج أقل قدر من النص ذي المعنى
```

## سمات الأسلوب التي تظهر بوضوح في النتيجة

- موضوع جوهري واحد يمكن التعرّف إليه بوضوح، ولا يرافقه إلا ما يشارك فعلاً في السرد من أشياء أو علاقات مكانية.
- أرضية شديدة الفتوح وقريبة من الأبيض تتكيف مع حرارة المصدر، وفراغ سلبي واسع يحمل العاطفة.
- يحافظ الغواش والأكريليك والباستيل والزيت الجاف المعتم على التوقفات والتعديلات والأرضية الظاهرة وشيء من عفوية اليد.
- تلتقي الأصفر الكريمي والمشمشي والخوخي والمرجاني والوردي القديم مع الأزرق السماوي والنعناعي والأخضر الرمادي في توتر دافئ／بارد مرن مع انزياحات لونية محلية.
- يمكن أن يكون الموضوع لامركزياً أو معلقاً أو منخفضاً أو مقتصاً جزئياً، وتدخل الكتابة الفراغ كجزء من الرسم لا كمعلومات ملصق آلية.

لا توجد القيود الجمالية وقواعد الرفض إلا في [الموجّه الأصلي](references/original-prompt/zh-CN.md)، أما المهارة ومهايئ التشغيل فيعالجان متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-056-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 056. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
# تطبيق Panel 056 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-056 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-056`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-056-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-056-prompt.zh-CN.md)
